...
3. **Create the folder structure** in `Learning/Plans/<CODE>/`:
   ```
   Learning/Plans/<CODE>/
     Weeks/
     Courses/
...
4. **Create `Learning/Plans/<CODE>/00_plan.md`**:
   ```markdown
   ---
   plan: <CODE>
   code: <CODE>
...
5. **Create `Learning/Plans/<CODE>/00_map.md`**:
   ```markdown
   ---
   plan: <CODE>
   code: <CODE>
...
- Use the confirmed code as the folder name (e.g. `Learning/Plans/AISA/`)
- If `Learning/Plans/<CODE>/` already exists, ask before overwriting any files
