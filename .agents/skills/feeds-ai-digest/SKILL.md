...
> [!GUARD] Read `system/modules/feeds-ai-digest/module.md`. If `enabled: false` → reply "⛔ Module **feeds-ai-digest** is disabled. Enable it via `/module-toggle feeds-ai-digest`." and STOP. Do NOT proceed.
